...
import com.xg.utils.ExcelOperactionTool;
import com.xg.utils.FileCommonOperactionTool;
import java.io.File;
...
public class DefaultSpiderImpl implements StockSpider {
  ...
  static {
    ...
    @Override
    public List<Map<String,Object>> getStockPrice(String[] stockCode) throws Exception {
    ...
    @Override
    public Map<String,Object> getStockInfo(String code) throws Exception {
...
//        json.put("listingDate",listingDate);//上市日期
    ...
    @Override
    public List<Map<String,Object>> getHistoryDividendRate(String code) throws Exception {
        String stockCode = code.replaceAll("\\D", "");
    ...
    @Override
    public List<Map<String,Object>> getHistoryROE(String code) throws Exception {
        ...
        //读取excel数据
        List<Object[]> list = ExcelOperactionTool
            .readExcelData(String.format("./data/%s_main_year.xls", code));
    ...
    @Override
    public List<Map<String,Object>> getHistoryPE(String code) throws Exception {
    ...
    @Override
    public List<Map<String,String>> getHistoryPB(String code) throws Exception {
    ...
    public List<String> getAllStockCode() throws Exception {
        ...
        try {
            ...
            OBJECT_MAPPER.readValue(text,Map.class,String.class,Object.class);
     ...
     * @throws Exception
     */
    public Map<String,String> getDy(int page) throws Exception {
